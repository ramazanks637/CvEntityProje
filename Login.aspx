        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-form-title" style="background-image: url(Login/images/bg-01.jpg);">
                    <span class="login100-form-title-1">ENTITY CV ADMIN PANEL</span>
                </div>

                <form class="login100-form validate-form" runat="server">
                    <div class="wrap-input100 validate-input m-b-26" data-validate="Kullanıcı Adı Girmediniz">
                        <span class="label-input100">Kullanıcı</span>
                        <asp:TextBox ID="TextBox1" runat="server" class="input100" placeholder="Kullanıcı"></asp:TextBox>
                        <span class="focus-input100"></span>
                    </div>

                    <div class="wrap-input100 validate-input m-b-18" data-validate="Şifre Girmediniz">
